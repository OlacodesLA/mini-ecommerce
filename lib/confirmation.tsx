...
const baseUrl =
  process.env.NEXT_PUBLIC_NODE_ENV === "development"
    ? `https://${process.env.NEXT_PUBLIC_BASE_URL_STAGGING}`
    : `https://${process.env.NEXT_PUBLIC_BASE_URL_PRODUCTION}`;

const items = [
  {
    name: "Yuletide",
    description: "This is a description of the yule item",
    quantity: 2,
    price: 4000,
  },
  {
...
const NikeReceiptEmail = ({
  ...
  const { address, city, country } = shippingInfo;
  return (
    <Html>
      <Head />
      <Preview>
        ...
        <Container style={container}>
          ...
          <Section style={message}>
            ...
            {cartInfo.map((item: any) => {
              const { name, items, quantity, price } = item;
              return (
                <Row
                  key={name}
          ...
          <Section style={paddingY}>
            <Text style={global.heading}>christmas.irolagos.com</Text>
            <Row style={categories.container}>
              <Column align="center">
                <Link
                  href="/https://christmas.irolagos.com"
              ...
              <Column align="center">
                <Link
                  href="https://christmas.irolagos.com/shop"
                  style={categories.text}
                >
                  Shop
                </Link>
              ...
              <Column align="center">
                <Link
                  href="https://christmas.irolagos.com/pack"
                  style={categories.text}
                >
                  Create Pack
                </Link>
              ...
              <Column align="center">
                <Link
                  href="https://christmas.irolagos.com/contact"
                  style={categories.text}
                >
                  Contact
                </Link>
